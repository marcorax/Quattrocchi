...
%               I2(y,x,r) = w_00*interp(1) + w_10*interp(2) + ...
%                   w_01*interp(3) + w_11*interp(4);

              I2(y,x,r) = nansum_mod([w_00*I1(y_w,x_w,r) w_10*I1(y_w,x_w+1,r) w_01*I1(y_w+1,x_w,r) w_11*I1(y_w+1,x_w+1,r)]);
